   ...
   return (
      <div>
         ...
         <form onSubmit={handleRegister} className="border max-w-xl mx-auto p-6 space-y-6 border-amber-500">
            ...
            <input className="border w-full p-2 text-center rounded-md border-amber-500 font-semibold text-amber-600 hover:bg-amber-500 hover:text-white duration-300 cursor-pointer" type="submit" value="Sign In"/>
            <p>Are you new here ? <Link to='/register' className="font-semibold text-amber-500">Sign Up</Link></p>
         </form>
      </div>
   );
};
